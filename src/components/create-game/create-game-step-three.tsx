  ...
  return (
    <div className="px-[40px]">
      ...
      <section className="py-[40px]">
        ...
        <div className="mb-6">
       <div className="flex flex-row w-3/5 p-3 border-2 border-[#E2E2E2] rounded-[8px] focus:outline-none 2 focus:border-indigo-600 bg-[#F5F7F9] drop-shadow-sm h-[85px] content-center">
